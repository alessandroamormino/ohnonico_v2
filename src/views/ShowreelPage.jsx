  ...
  return (
    <Box sx={{ backgroundColor: theme.palette.background.main, color: '#fff' }}>
      ...
      <Box sx={{ textAlign: 'center', mt: {xs: 1, md: 0}, px: {xs: 3, md: 0} }}>
        <Typography variant="h3" component="p" sx={{ fontFamily: "Light", fontSize: {xs: "3rem", md: "3.5rem"}}}>
          ONN
        </Typography>
        <Typography variant="h1" component="p" sx={{ fontFamily: "Light", fontSize: {xs: "2.5rem", md: "3rem"} }}>
          LOVEREEL 22
        </Typography>
				<Typography
          variant="body1"
